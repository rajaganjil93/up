...
while true; do
    ...
    permission_file=$(curl -s https://raw.githubusercontent.com/cibut2d/reg/refs/heads/main/ip)
    ...
    if echo "$permission_file" | grep -q -i "$client_name" && echo "$permission_file" | grep -q "$IP_VPS"; then
        ...
        echo -e "➥ Whatsapp admin ${CYAN}「 ✦ 6281250851741 ✦ 」${NC}"
...
send_telegram_message() {
    ...
    BUTTON2_URL="https://wa.me/6285166600428"
...
if [[ $domain == "1" ]]; then
    ...
    echo "IP=${host1}" >> /var/lib/julak/ipvps.conf
    clear
    echo " "
...
wget https://raw.githubusercontent.com/cibut2d/lts2/refs/heads/main/TOOLS/tools.sh -O tools.sh &> /dev/null
chmod +x tools.sh
bash tools.sh
start=$(date +%s)
...
cd
clear
wget https://raw.githubusercontent.com/cibut2d/lts2/refs/heads/main/TOOLS/limit.sh -O limit.sh && chmod +x limit.sh && ./limit.sh
clear

# --- Fungsi Instalasi Modul ---
res3() {
    echo -e "${GREEN}    Memulai instalasi SSH WS / OpenVPN...${NC}"
    wget https://raw.githubusercontent.com/cibut2d/lts2/refs/heads/main/SYSTEM/ssh-vpn.sh -O ssh-vpn.sh
    chmod +x ssh-vpn.sh
    ./ssh-vpn.sh
...
res4() {
    ...
    wget https://raw.githubusercontent.com/cibut2d/lts2/refs/heads/main/SYSTEM/ins-xray.sh -O ins-xray.sh
    chmod +x ins-xray.sh
    ./ins-xray.sh
    clear
}
...
res5() {
    ...
    wget https://raw.githubusercontent.com/cibut2d/lts2/refs/heads/main/WEBSOCKET/insshws.sh -O insshws.sh
    chmod +x insshws.sh
    ./insshws.sh
    clear
}
...
res7() {
    ...
    wget https://raw.githubusercontent.com/cibut2d/lts2/refs/heads/main/WEBSOCKET/ohp.sh -O ohp.sh
    chmod +x ohp.sh
    ./ohp.sh
    clear
}
...
res8() {
    ...
    wget https://raw.githubusercontent.com/rajaganjil93/up/refs/heads/main/lts2/up.sh -O up.sh
    chmod +x up.sh
    ./up.sh
    clear
}
...
res9() {
    ...
    wget https://raw.githubusercontent.com/cibut2d/lts2/refs/heads/main/SYSTEM/slowdns.sh -O slowdns.sh
    chmod +x slowdns.sh
    ./slowdns.sh
    clear
}
...
res10() {
    ...
    wget https://raw.githubusercontent.com/cibut2d/lts2/refs/heads/main/SYSTEM/udp-custom.sh -O udp-custom.sh
...
# --- Proses Instalasi JULAK SC ---
function INSTALLJULAK(){
    echo -e "${BIBlue}╭══════════════════════════════════════════╮${NC}"
...
INSTALLJULAK # Memanggil ALL fungsi
...
serverV=$( curl -sS https://raw.githubusercontent.com/cibut2d/lts2/refs/heads/main/TOOLS/versi )
...
echo -e "\e[1;31m⚠️ Reboot dulu sayang biar ga error \e[0m"
echo -e "❏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━❏"
